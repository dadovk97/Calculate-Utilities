...
class CountGas : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSaveGas.setOnClickListener {
            ...
            if (!ifPressedCountGas)
                Toast.makeText(this@CountGas, "You have to count before saving!", Toast.LENGTH_LONG)
                    .show()
    ...
    private fun pickGasCompany() {
        ...
        spinnerCompany.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
                    ...
                    spinnerTariff.onItemSelectedListener =
                        object : AdapterView.OnItemSelectedListener {
                            ...
                            override fun onNothingSelected(p0: AdapterView<*>?) {
                                Toast.makeText(
                                    this@CountGas,
                                    "You have to select tariff model!",
                                    Toast.LENGTH_LONG
                                ).show()
                            }
                        }
            ...
            override fun onNothingSelected(p0: AdapterView<*>?) {
                Toast.makeText(this@CountGas, "You have to select gas company!", Toast.LENGTH_LONG)
                    .show()
            }
        }
    }
